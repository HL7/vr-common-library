...
#run:
#ruby tools/makeStructureDefinitionIntrosFromCSVtoHTML.rb input/mapping/VRCL_Profile_Intros.csv input/mapping/IJE_File_Layouts_and_FHIR_Mapping_24-06-21.csv input/mapping/Forms_Mapping.csv

#output: after running script, generated files will be in the /generated folder. Copy or move generated files to /input/pagecontent in order for updated content to be included in IG
