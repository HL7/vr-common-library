Instance: observation-autopsy-performed-vr-not-named-common
...
* subject = Reference(patient-decedent-fetus-vr-not-named-common)
* effectiveDateTime = "2019-12-02"
* focus = Reference(Practitioner/practitioner-vr-janet-seito-common)
