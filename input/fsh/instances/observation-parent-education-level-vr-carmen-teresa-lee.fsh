...
* subject = Reference(patient-decedent-fetus-vr-not-named-common) "Patient - Decedent Fetus (Fetus Not Named)"
* focus = Reference(relatedperson-mother-gestational-vr-carmen-teresa-lee-common) "Patient - Mother (Carmen Teresa Lee)"
* effectiveDateTime = "2019-12-02"
* performer = Reference(relatedperson-mother-gestational-vr-carmen-teresa-lee-common)
