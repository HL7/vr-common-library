...
Profile conformance requires that gender be provided, see [note on patient gender](http://build.fhir.org/ig/HL7/vr-common-library/branches/master/usage.html#gender).
